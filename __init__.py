...
from .qwen_image21_nodes import (
    NODE_CLASS_MAPPINGS as QWEN21_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as QWEN21_NODE_DISPLAY_NAME_MAPPINGS,
)
...
from .h3_lipsync_nodes import (
    NODE_CLASS_MAPPINGS as H3_LIPSYNC_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as H3_LIPSYNC_NODE_DISPLAY_NAME_MAPPINGS,
)
from .h3_streaming_nodes import (
    NODE_CLASS_MAPPINGS as H3_STREAMING_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as H3_STREAMING_NODE_DISPLAY_NAME_MAPPINGS,
)
from .avatarforever_nodes import (
    NODE_CLASS_MAPPINGS as AVATARFOREVER_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as AVATARFOREVER_NODE_DISPLAY_NAME_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS.update(H3_LIPSYNC_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(H3_LIPSYNC_NODE_DISPLAY_NAME_MAPPINGS)
NODE_CLASS_MAPPINGS.update(H3_STREAMING_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(H3_STREAMING_NODE_DISPLAY_NAME_MAPPINGS)
NODE_CLASS_MAPPINGS.update(AVATARFOREVER_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(AVATARFOREVER_NODE_DISPLAY_NAME_MAPPINGS)
NODE_CLASS_MAPPINGS.update(QWEN21_NODE_CLASS_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(QWEN21_NODE_DISPLAY_NAME_MAPPINGS)
